...
class Config(object):
    ...
    BOT_NAME = getenv("BOT_NAME", "🔥⃝⃪⃕ 𝐈𝐆❱❥︎≛⃝𝐆𝐇𝐎𝐒𝐓❱❥︎🔥⃝⃪⃕𝐌𝐔𝐒𝐈𝐂⃝.")   # dont put fancy texts here.
    BOT_PIC = getenv("BOT_PIC", "https://graph.org/file/8d4988df8b538a1b717ca.jpg")           # put direct link to image here
